      ...
      <section ref={dialogRef} className="flight-editor" role="dialog" aria-modal="true" aria-labelledby="flight-editor-title">
        ...
        <form onSubmit={submit} aria-describedby={error ? errorId : undefined}>
          <div className="editor-grid">
            ...
            <AirportCombobox label={t("status.diverted")} locale={locale} value={draft.divertedToIata ?? ""} onChange={(iata) => update("divertedToIata", iata)} required={false} preferredCodes={preferredAirportCodes} />
          </div>
