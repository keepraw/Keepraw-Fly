...
The directory can be served by Cloudflare Pages, Vercel, Netlify, Nginx, Caddy
or an ordinary static file server.
...
browser's IndexedDB. This repository intentionally does not include an
automatic deployment workflow; hosting is configured and triggered separately.
